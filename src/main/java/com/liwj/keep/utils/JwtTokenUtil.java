...
public class JwtTokenUtil {
    ...
    public static String createJWT(String userId, String username, String role, Audience audience) {
        try {
            ...
            //userId是重要信息，进行加密下
            String encryId = Base64Util.encodeBase64(userId);
            //添加构成JWT的参数
    ...
    public static String getUserId(String token, String base64Security){
        ...
        return Base64Util.decodeBase64(userId);
    }
    /**
     * 是否已过期
     * @param token
  ...
  /*  public static void main(String[] args) {
        ...
        audience.setClientId("1");
        audience.setExpiresSecond(60*60);
        audience.setName("admin");
        audience.setBase64Secret("admin");
        String jwt = JwtTokenUtil.createJWT("1","admin","admin",audience);
        Claims parseJWT(jwt,)
